...
다른 Codex·Claude·개발자는 먼저 아래 문서를 읽는다.

1. [마스터 인수인계](./docs/HANDOFF_MASTER_2026-08-03.md)
2. [프로젝트 파일 지도](./docs/PROJECT_FILE_MAP_2026-08-03.md)
3. [작업 큐](./docs/WORK_QUEUE_2026-08-03.md)

현재 작업 트리에 미커밋 매장 등록 보완 파일이 있으므로, 새 작업을 시작하기 전 반드시 `git status --short`를 확인한다.
